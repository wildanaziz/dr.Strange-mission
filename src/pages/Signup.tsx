...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-secondary-dark flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-center">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Mulai perjalanan belajarmu menuju PTN impian bersama ribuan siswa lainnya.
          </p>
          ...
          <div className="mt-8 space-y-4 text-left">
            <div className="flex items-center gap-3 text-white/90">
              ...
              <span>Try-out GRATIS tanpa batas</span>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <div className="w-8 h-8 rounded-full bg-accent flex items-center justify-center">
                <span className="text-sm font-bold text-secondary-dark">✓</span>
              </div>
              <span>Soal HOTS berkualitas tinggi</span>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <div className="w-8 h-8 rounded-full bg-accent flex items-center justify-center">
                <span className="text-sm font-bold text-secondary-dark">✓</span>
              </div>
              <span>Pembahasan lengkap & mudah</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-start lg:justify-center items-center p-6 md:p-12 bg-neutral-bg flex-1 rounded-t-3xl lg:rounded-none -mt-4 lg:mt-0 relative z-10 overflow-y-auto">
        <Link to="/" className="hidden lg:block mb-6">
          <img
            src="/assets/PASTI PINTAR NEW-02-02.png"
            alt="Pasti Pintar Logo"
        ...
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full py-3.5 bg-white border border-neutral-border rounded-xl font-semibold text-neutral-text hover:bg-gray-50 transition-all flex items-center justify-center gap-3 shadow-sm hover:shadow-md mb-6"
          >
          ...
          <div className="flex items-center mb-6">
            ...
            <span className="px-4 text-sm text-neutral-text/70">atau daftar dengan email</span>
            <div className="flex-1 h-px bg-neutral-border"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Full Name Input */}
            <div>
              <label htmlFor="fullName" className="block text-sm font-semibold text-secondary-dark mb-2">
                Nama Lengkap
              </label>
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-text/50" />
                <input
                  type="tel"
                  id="phone"
                  name="phone"
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-4 h-4 text-primary border-neutral-border rounded focus:ring-primary cursor-pointer"
              />
              <label htmlFor="terms" className="text-sm text-neutral-text cursor-pointer">
                Saya menyetujui{' '}
                <a href="#" className="text-primary font-medium hover:text-primary-hover">
                  Syarat & Ketentuan
                </a>{' '}
                dan{' '}
                <a href="#" className="text-primary font-medium hover:text-primary-hover">
